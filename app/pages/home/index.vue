<template>
  <!-- <div class="grid gap-4 grid-cols-2">
    <div>
      <InvChart :labels="labels" :preSynergyData="preSynergyData" :postSynergyData="postSynergyData" :chartWidth="700"
        :chartHeight="500" :barSpacing="15" orientation="vertical" />
    </div>
    <div>
      <HorizontalBarChart :labels="labels" :preSynergyData="preSynergyData" :postSynergyData="postSynergyData"
        :chartWidth="600" :chartHeight="600" :barHeight="30" :barSpacing="25" :valueScaleSteps="7" />
    </div>
  </div> -->
    ...
    <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <div style="display: inline-block; width: 100%">
        ...
        <div class="py-5 pr-4 float-right">
          <button class="text-white flex addItem font-medium rounded-lg text-sm px-3 py-2.5 me-2 mb-2">
          ...
          <template #action="{ item }">
            <div class="action-buttons">
              <button @click="editItem(item)"
                ...
                <svg class="h-5 w-5 text-slate-700" width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
                  stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" />
              ...
              <button @click="deleteItem(item)"
                ...
                <svg class="h-5 w-5 text-red-700" width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
                  stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" />
