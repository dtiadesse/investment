      ...
      const { customSafelistExtractor, generateSafelist } = require("C:/UI/code/investment/node_modules/@nuxt/ui/dist/runtime/utils/colors")
      ...
      module.exports = {
        ...
        content: {
          files: [
            "C:/UI/code/investment/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "C:/UI/code/investment/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
